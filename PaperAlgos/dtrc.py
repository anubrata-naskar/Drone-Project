...
class DTRC:
    def __init__(self, truck_count, capacity, x_coords, y_coords, demands, distance_matrix, drone_capacity):
        """
        ...
        """
        self.num_trucks = truck_count
        self.capacity = capacity
        self.x_coords = x_coords
        self.y_coords = y_coords
        self.demands = demands
        self.distances_df = distance_matrix
                    ...
                    if potential_deliveries:
                        ...
                        for num_nodes in range(1, max_nodes + 1):
                            for combo in [potential_deliveries[:num_nodes]]:  # Just take the first num_nodes
                                ...
                                if total_payload > self.drone_capacity:
                                    continue
