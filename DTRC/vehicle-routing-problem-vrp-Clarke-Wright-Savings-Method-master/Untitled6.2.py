...
def apply_dtrc(truck_routes, drone_nodes, distances_df, demands, d_capacity):
...
drone_routes, truck_routes = apply_dtrc(truck_routes, drone_nodes, distances_df, demands, d_capacity)
